...
##The exact same logic is used in order to extrace necessary information in order to crack ciphertext#
...
#Once the necessary information has been extracted, the same function from first challenges can be used in order to break the cipher
